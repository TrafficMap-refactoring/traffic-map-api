...
public class BusArrInfoByRouteDto {
  ...
  public String busType1; //첫번째 도착 예정 버스의 차량 유형
  public String busType2; //두번째 도착 예정 버스의 차량 유형
  public String firstTm; //첫차시간
  public String full1; //첫번째 도착 예정 버스의 만차 여부
  public String full2; //두번째 도착 예정 버스의 만차 여부
  public String isArrive1; //첫번재 도착 예정 버스의 최종 정류소 도착 출발 여부
  public String isArrive2; //두번재 도착 예정 버스의 최종 정류소 도착 출발 여부
  public String isLast1; //첫번째 도착 예정 버스의 막차 여부
  public String isLast2; //두번째 도착 예정 버스의 막차 여부
  ...
  public String staOrd; // 요청 정류소 순번
  public String term; //배차간격
